...
class Linear_M(Module):
    ...
    def __init__(self, input_size, output_size):
        ...
        w = np.random.randn(output_size, input_size) /np.sqrt(output_size/ 2)
        self.w = TensorNode(w)
...
class MLP_M(Module):
    ...
    def __init__(self, input_size, output_size, hidden_mult=4):
        ...
        self.layer1 = Linear_M(input_size, hidden_size)
        self.layer2 = Linear_M(hidden_size, output_size)
        self.layer3 = Linear_M(hidden_size, hidden_size)
